...
export default function FacilitiesPreview() {
  return (
    <section id="facilities" className="py-16 sm:py-20 bg-slate-100/70">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col sm:flex-row justify-between sm:items-end gap-3 mb-8 sm:mb-12">
          <h2 className="font-display text-2xl sm:text-3xl md:text-4xl font-semibold text-slate-950">
            Facilities Preview
          </h2>
          <a
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          {/* Dormitory Card */}
          <div className="group relative overflow-hidden rounded-xl shadow-sm h-56 sm:h-64">
            <div
            ...
            ></div>
            <div className="absolute inset-0 bg-gradient-to-t from-slate-950/90 via-slate-950/30 to-transparent flex items-end p-5 sm:p-6">

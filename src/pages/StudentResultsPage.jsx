            ...
            <table className="w-full min-w-[650px] border-collapse text-left text-sm whitespace-nowrap">
              ...
              <tbody className="divide-y divide-outline-variant/40">
                {results.map((result) => (
                  ...
                  >
                    <td className="px-4 py-3.5 font-medium text-primary">{result.subject}</td>
                    <td className="px-4 py-3.5 text-on-surface-variant">{result.term}</td>
                    <td className="px-4 py-3.5 text-on-surface-variant">{result.session}</td>
                    <td className="px-4 py-3.5 text-center">{result.caScore}</td>
                    <td className="px-4 py-3.5 text-center">{result.examScore}</td>
                    <td className="px-4 py-3.5 text-center font-semibold text-primary">{result.total}</td>
                    ...
                    <td className="px-4 py-3.5 text-secondary font-medium">{result.remark}</td>
                  </tr>
                ))}
              </tbody>
            </table>
